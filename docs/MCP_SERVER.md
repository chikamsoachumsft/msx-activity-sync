...
> **Looking for the scheduled CRM activity sync agent?** See [docs/ACTIVITY_SYNC.md](docs/ACTIVITY_SYNC.md) — autonomous calendar → CRM task sync, runs unattended via Task Scheduler. One-command setup: `.\install\setup.ps1`.
